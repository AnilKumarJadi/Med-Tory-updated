...
function UserManagement() {
  ...
  const {
    ...
    setDataShow,
    getRole,
    setgetRole, showAddBtn, setShowAddBtn
  } = userInfo;
  ...
  const validateForm = () => {
    ...
    if (!userData.username || userData.username.trim() === "") {
      ...
      errors.username = "Max 40 Characters only";
    }
    ...
    <>
      ...
      <div className="user-container w-100">
        ...
        <div className="d-flex justify-content-between m-3">
          {
            getRole.role === "superadmin" ? "" : showAddBtn && (<button className="btn btn-primary " onClick={handleShow}>Add User
            ...
            <div className="p-2 col-lg-6 col-md-6 col-sm-12">
              ...
              <input
                ...
                onChange={(e) =>
                  setUserData({
                    ...userData,
                    password: e.target.value.padStart(userData.password, "*"),
                  })
                }
              // required
              />
